...
public class AdapterTransferencia extends RecyclerView.Adapter<AdapterTransferencia.ViewHolder> {
    ...
    Context mcontext;
    DatTransferenciaModel datTransferenciaModel;
    ...
    public AdapterTransferencia(Context context) {
        ...
        this.datTransferenciaModel = new DatTransferenciaModel(context);
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        try {
            List<DatTranferencia> tranferencias = datTransferenciaModel.getTranferencias();
    ...
    public int getItemCount() {
        ...
        try {
            cant = datTransferenciaModel.getTranferencias();
        } catch (SQLException e) {
            e.printStackTrace();
        }
        return cant.size();
